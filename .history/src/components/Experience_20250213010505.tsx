...
const experiences: Experience[] = [
  ...
  },
  {
    ...
    organization: 'University of Waterloo Computer Science Club',
    description: [
      'Organized and facilitated various club events from planning to post-event evaluation.',
  ...
  },
  {
    ...
    description: [
      ...
      'Provided hands-on guidance and mentoring to students in their learning journey.'
    ],
    type: 'work'
  },
  {
...
const clubs = [
  {
    ...
    description: [
      'Actively involved in AI research and development.',
      'Contributed to OpenAI-related initiatives and projects.'
    ],
    type: 'club'
  },
  {
    title: 'Volunteer',
    organization: 'UW Women in Computer Science Club',
    description: [
      'Assisted in organizing Technovation workshops for women in tech.',
      'Supported TechNova events and provided guidance to participants.'
    ],
    type: 'club'
  },
  {
