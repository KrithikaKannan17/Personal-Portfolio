        ...
        <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              {experiences.map((exp, index) => (
                ...
                >
                  ...
                  <div className="bg-white/10 backdrop-blur-md p-6 rounded-lg shadow-lg border border-white/20 ml-4">
          ...
          >
            <div className="flex items-center mb-8">
              ...
              <h2 className="text-2xl font-semibold text-white">Clubs & Activities</h2>
            </div>
            <div className="space-y-8">
              {clubs.map((club, index) => (
                ...
                >
                  <div className="timeline-dot" />
                  <div className="bg-white/10 backdrop-blur-md p-6 rounded-lg shadow-lg border border-white/20 ml-4">
                    <h3 className="text-xl font-semibold text-white">{club.title}</h3>
