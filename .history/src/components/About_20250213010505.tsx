        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
          ...
          >
            <p className="text-lg text-gray-700 leading-relaxed">
              ...
              I'm passionate about software development, AI, and robotics.
            </p>
            <p className="text-lg text-gray-700 leading-relaxed">
              Right now, I'm working on full-stack development, algorithm design, and automation, 
              while also exploring machine learning, embedded systems, and cybersecurity.
            </p>
            <p className="text-lg text-gray-700 leading-relaxed">
              I've built projects in Python, Racket, and C, including QR code detection robots, 
            ...
            <p className="text-lg text-gray-700 leading-relaxed">
              ...
              I am currently seeking Summer 2025 internships in software engineering, AI, or robotics—let's connect!
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600">Machine learning and automation solutions</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md">
              <Mic className="w-12 h-12 text-primary mb-4" />
              <h3 className="text-xl font-semibold mb-2">Public Speaking</h3>
              <p className="text-gray-600">Event organization and presentations</p>
            </div>
          </motion.div>
        </div>
      </div>
